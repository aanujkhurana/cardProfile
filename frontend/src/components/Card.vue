...
const setupIntersectionObserver = () => {
  if ('IntersectionObserver' in window) {
    ...
    const animatableElements = safeQuerySelectorAll('.service-item, .testimonials-item, .project-item, .blog-post-item');
    ...
    <aside class="sidebar" data-sidebar>
      ...
      <div class="sidebar-info">
        ...
        <div class="info-content">
          <h1 class="name" title="Richard hanrick">Anuj Khurana</h1>
        ...
        <ul class="contacts-list">
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="mailto:aanujkhurana@gmail.com" class="contact-link">aanujkhurana@gmail.com</a>
            </div>
